...
- **Status:** Fully resolved — all five decisions answered (ADRs 0007–0010, 0015)
- **Date:** 2026-09-20
- **Workstream:** A
...
| 3 | ~~Survey format: PDF plat, CAD file, or satellite image only?~~ **Answered: raster image plus two-point georeferencing.** See ADR 0015. | S7 | — |
...
5 came back narrower than their defaults (ADRs 0009 and 0010); decision 3
confirmed its default (ADR 0015). Nothing here is open.
