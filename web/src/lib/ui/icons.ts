...
export const ICONS = {
  ...
  seedling: {
    plain: 'New plant',
    paths: ['M12 21v-8', 'M12 13C12 8.5 8.5 6 4 6c0 4.5 3.5 7 8 7z', 'M12 13c0-4.5 3.5-7 8-7 0 4.5-3.5 7-8 7z']
  },
  quill: {
    plain: 'Log',
  ...
  book: {
    plain: 'Journal',
    paths: ['M4 4h6a3 3 0 0 1 3 3v13a3 3 0 0 0-3-3H4z', 'M20 4h-6a3 3 0 0 0-3 3v13a3 3 0 0 1 3-3h6z']
  },
  pin: {
    plain: 'Location',
    paths: ['M12 22s7-7.5 7-12a7 7 0 1 0-14 0c0 4.5 7 12 7 12z', 'M14.5 10a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z']
  },
  search: {
    plain: 'Search',
